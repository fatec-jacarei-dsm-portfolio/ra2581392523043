...
export const myProjects = [
    {
        ...
        texture: '/textures/project/videokayman.mp4',
        logo: '/assets/AgriRSlab.png',
        logoStyle: {
    ...
    },
    {
        ...
        texture: '/textures/project/nexatech.mp4',
        logo: '/assets/fatec.jpeg',
        logoStyle: {
